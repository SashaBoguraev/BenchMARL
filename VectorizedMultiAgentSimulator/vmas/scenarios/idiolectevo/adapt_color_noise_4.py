...
class Scenario(BaseScenario):
    ...
    def reset_world_at(self, env_index: int = None):
        if env_index is None:
            ...
            colors = [
                torch.tensor(
                    [0.00088263, 0.77384509, 0.53162081], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.05517648, 0.81501307, 0.05885222], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.06002518, 0.05998185, 0.6771494 ], device=self.world.device, dtype=torch.float32
                )
            ]
