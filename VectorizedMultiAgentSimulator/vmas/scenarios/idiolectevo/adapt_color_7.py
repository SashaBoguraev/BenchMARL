...
class Scenario(BaseScenario):
    ...
    def reset_world_at(self, env_index: int = None):
        if env_index is None:
            ...
            colors = [
                torch.tensor(
                    [0.18536073, 0.26313892, 0.80105569], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.96693974, 0.44678552, 0.54637898], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.43612918, 0.5773245 , 0.90387858], device=self.world.device, dtype=torch.float32
                )
            ]
