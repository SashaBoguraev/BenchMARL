...
class Scenario(BaseScenario):
    ...
    def reset_world_at(self, env_index: int = None):
        if env_index is None:
            ...
            colors = [
                torch.tensor(
                    [0.4850128 , 0.69049697, 0.27538108], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.33821408, 0.18677087, 0.25459189], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.44838321, 0.16839406, 0.05772603], device=self.world.device, dtype=torch.float32
                )
            ]
