...
class Scenario(BaseScenario):
    ...
    def reset_world_at(self, env_index: int = None):
        if env_index is None:
            ...
            colors = [
                torch.tensor(
                    [0.65749074, 0.05481696, 0.34342548], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.4298633 , 0.70046802, 0.14097923], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.5459428 , 0.70191707, 0.32869117], device=self.world.device, dtype=torch.float32
                )
            ]
