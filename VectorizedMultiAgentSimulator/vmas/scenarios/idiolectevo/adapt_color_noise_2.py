...
class Scenario(BaseScenario):
    ...
    def reset_world_at(self, env_index: int = None):
        if env_index is None:
            ...
            colors = [
                torch.tensor(
                    [0.89998341, 0.05672149, 0.82084172], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.35678811, 0.11135403, 0.85474062], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.49499374, 0.12011904, 0.42012681], device=self.world.device, dtype=torch.float32
                )
            ]
