...
class Scenario(BaseScenario):
    ...
    def reset_world_at(self, env_index: int = None):
        if env_index is None:
            ...
            colors = [
                torch.tensor(
                    [0.47334232, 0.86563882, 0.29770234], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.58307859, 0.16856888, 0.02680049], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.75996964, 0.95323119, 0.84281999], device=self.world.device, dtype=torch.float32
                )
            ]
