...
class Scenario(BaseScenario):
    ...
    def reset_world_at(self, env_index: int = None):
        if env_index is None:
            ...
            colors = [
                torch.tensor(
                    [0.16546759, 0.64553364, 0.60657187], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.2233982 , 0.26297057, 0.35569658], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.05366605, 0.99556967, 0.28615281], device=self.world.device, dtype=torch.float32
                )
            ]
