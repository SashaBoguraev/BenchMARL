...
class Scenario(BaseScenario):
    ...
    def reset_world_at(self, env_index: int = None):
        if env_index is None:
            ...
            colors = [
                torch.tensor(
                    [0.02149317, 0.27452798, 0.02416028], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.34628072, 0.8350758 , 0.11225597], device=self.world.device, dtype=torch.float32
                ),
                torch.tensor(
                    [0.5598136 , 0.78172008, 0.28490428], device=self.world.device, dtype=torch.float32
                )
            ]
